...
*/
class Constraint : public osg::Object
{
public:
    Constraint();
...
This class uses btSliderConstraint internally. Access the Bullet constraint
directly with getAsBtSlider(). */
class TwistSliderConstraint : public Constraint
{
public:
...
struct InternalSpringData : public osg::Object
{
    InternalSpringData();
...
class LinearSpringConstraint : public Constraint
{
public:
...
Bullet constraints, calling code must specify two rigid bodies. Constraining
one rigid body to a sping is not supported by Bullet. */
class AngleSpringConstraint : public Constraint
{
public:
...
Bullet constraints, calling code must specify two rigid bodies. Constraining
one rigid body to a sping is not supported by Bullet. */
class LinearAngleSpringConstraint : public Constraint
{
public:
...
*/
class CardanConstraint : public Constraint
{
public:
    CardanConstraint();
...
Need to investigate. */
class RagdollConstraint : public Constraint
{
public:
    RagdollConstraint();
...
*/
class WheelSuspensionConstraint : public Constraint
{
public:
